<div class="modal fade" id="modalConfirm{{ $v->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content rounded-0">
                ...
                <div class="content">
                    <div class="m-b-3">
                        ...
                        <h4><i class="fa fa-warning"></i> Peringatan:</h4>
                            Harap perhatikan jumlah nominal penarikan dan nomor rekening yang dikirim oleh user
                        </div>
                        <div class="row mt-2">
                            <div class="col">
            ...
            <div class="modal-footer">
                <a href="{{ route('withdraw.admin.accept', $v->id) }}" class="btn btn-primary">Konfirmasi</a>
            </div>
        </div>
    </div>
</div>
